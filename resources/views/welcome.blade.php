...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>E-Greygarth</title>

        <!-- Fonts -->
        <link rel="preconnect" thref="https://fonts.bunny.net">
    ...
    <body class="antialiased">
        <div class="relative min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            <div class="max-w-7xl mx-auto p-6 lg:p-8 flex flex-col lg:flex-row items-center">
                <div class="lg:w-1/2 flex justify-center items-center">
                    <img src="https://www.greygarth.org.uk/wp-content/uploads/2017/11/Logo-with-name-HALL.png" alt="Greygarth Hall Logo" class="img-fluid" style="width: 400px; height: 600px;">
                </div>
